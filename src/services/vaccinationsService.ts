...
import type { VaccinationInput, PaginatedResponse, VaccinationResponse } from '@/types/swaggerTypes';
...
export class VaccinationsService extends BaseService<VaccinationResponse> {
   ...
   */
  public async getVaccinations(options: { page?: number; limit?: number } = {}): Promise<PaginatedResponse<VaccinationResponse>> {
