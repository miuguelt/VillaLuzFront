...
import { sidebarItems, type Role as SidebarRole } from '@/widgets/dashboard/sidebarConfig';
        ...
        <div className="p-3 sm:p-4 border-b border-border bg-surface">
          <div className="flex items-center justify-between">
            <Link
              ...
              className="flex items-center gap-3 relative z-10 rounded-md px-1 py-1 -m-1 transition-colors hover:bg-state-hover focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-surface"
